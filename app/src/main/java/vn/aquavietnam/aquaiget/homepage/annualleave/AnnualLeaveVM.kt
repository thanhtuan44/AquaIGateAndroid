...
import vn.aquavietnam.aquaiget.homepage.nonscan.NonScanAdapter
import vn.aquavietnam.aquaiget.model.AnnualLeave
...
class AnnualLeaveVM(context: Context?): BaseVM() {
