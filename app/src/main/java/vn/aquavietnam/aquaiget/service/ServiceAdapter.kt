...
/**
 * Created by ThanhTuan on 3/26/2018.
 */
class ServiceAdapter(var context: Context, private  var arrCategoryService: List<Category>) : BaseAdapter() {

    lateinit var categoryRowBinding: CategoryRowBinding

    override fun itemCount(): Int {
        return if (arrCategoryService != null) {
            arrCategoryService!!.size
        } else {
            0
        }
    }
    ...
    override fun bindBaseViewHolder(holder: BindingViewHolder, position: Int) {
        ...
        categoryRowBinding.category = arrCategoryService!![position]
